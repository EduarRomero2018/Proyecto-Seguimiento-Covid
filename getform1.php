...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $fecha_recepcion_programacion = $_POST['fecha_recepcion_programacion_'];
  $hora = date('h:i:s');
  $fecha_recepcion = $fecha_recepcion_programacion.' '.$hora;
  ...
  if (
    empty($tipo_paciente) || empty($primer_nombre) || empty($primer_apellido) || empty($segundo_apellido)
  ...
  (:tipo_paciente, :primer_nombre, :segundo_nombre, :primer_apellido, :segundo_apellido, :tipo_documento, :numero_documento, :edad, :unidad_medida, :sexo, :barrio, :correo, :telefono, :aseguradora, :fecha_prog_recep, :id_usuario)"
    ...
    $consulta->execute(array(
      ...
      ':fecha_prog_recep'                    => $fecha_recepcion
    ));

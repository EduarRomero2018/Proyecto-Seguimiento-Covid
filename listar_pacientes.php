...
if (!isset($_REQUEST['consulta'])) {
    ...
    WHERE pacientes.estado_paciente = 'VIVO' AND aseguradora = 'MUTUAL SER' AND municipio LIKE '$sede%' AND prog_toma_muestra.resultado = 3 AND prog_toma_muestra.resultado != 2 $filtro";

...
include 'conexion.php';
    ...
    $consulta = $conexion->prepare(
        ...
        STM.notificado AS notificado_2, STM.fecha_programacion AS fecha_programacion_2, STM.resultado AS segunda_toma, PTM.resultado AS primera_toma
        FROM pacientes P
        ...
        WHERE PTM.resultado = 'Negativo' AND estado_paciente = 'VIVO' AND aseguradora = 'MUTUAL SER' OR STM.resultado = 2");

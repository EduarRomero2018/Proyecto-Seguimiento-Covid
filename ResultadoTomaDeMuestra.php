...
foreach ($_REQUEST as $key) {
  ...
  try {
    ...
    $stm = $conexion->prepare("UPDATE prog_toma_muestra SET fecha_entrega_lab = ?,fecha_resultado = ?,estado_proceso = 'FINALIZADO',resultado = ?, notificado = ?, fecha_notificacion = ? WHERE pacientes_id = $id");
